...
Namespace InteractiveConstantLine
    Partial Public Class Form1
        ...
        Handles chartControl1.MouseDown
            ...
            If (Not coords.IsEmpty) AndAlso TypeOf line.AxisValue Is DateTime AndAlso _
                coords.DateTimeArgument.Equals(CDate(line.AxisValue)) Then
        ...
        Handles chartControl1.MouseMove
            ...
            Else
                ...
                If TypeOf line.AxisValue Is DateTime AndAlso _
                    coords.DateTimeArgument.Equals(CDate(line.AxisValue)) Then
                    SetCursor()
                Else
                    RestoreCursor()
